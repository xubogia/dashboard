  ...
  return (
    ...
    >
      <List component="nav" aria-label="main mailbox folders" className="p-4 mt-4 ">
        ...
        <ListItemButton
          selected={currentPage === '商城'}
          className={`${currentPage === '商城' ? ' text-yellow-100 font-bold' : 'text-white'}`}
          onClick={() => handleListItemClick('/mall')}
        >
          <ListItemIcon>
            <MallIcon className="text-white" />
          </ListItemIcon>
        ...
        <ListItemButton
          ...
          className={`${currentPage === '设置' ? ' text-yellow-100 font-bold' : 'text-white'}`}
