    ...
    <div className={'w-full  flex-grow flex flex-col  px-8 py-4 border'}>
      <div className='flex  items-center  '>
        ...
        <div className={'flex-grow text-center'}>
          <button className='bg-blue-500 text-white py-2 px-20 rounded-md' onClick={handleOpenAddProductDialog}>添加商品</button>
          {addProductDialog&&<AddProductDialog open={addProductDialog} handleClose={handleCloseAddProductDialog} isProductAdd={handleIsProductAdd}/>}
        </div>
      </div>
        ...
        <div className={'h-10 flex flex-row justify-between items-center'}>
          <div className={'h-full flex flex-row'}>
            <div className={'h-full flex items-center justify-center space-x-2'}>
              <button className={'w-20 h-6 rounded-lg bg-red-500 text-white text-xs tracking-widest'} onClick={handleProductsDelete}>删除</button>
              <button className={'w-20 h-6 rounded-lg bg-green-500 text-white text-xs tracking-widest'} onClick={handleOnSelLClick}>上架</button>
              <button className={'w-20 h-6 rounded-lg bg-blue-500 text-white text-xs tracking-widest'} onClick={handleOffSellClick}>下架</button>
            </div>
          </div>
